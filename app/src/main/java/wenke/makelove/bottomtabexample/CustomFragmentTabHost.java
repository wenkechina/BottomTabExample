...
public class CustomFragmentTabHost extends TabHost implements
	...
	static class SavedState extends BaseSavedState {
		...
		public String toString() {
			return "CustomFragmentTabHost.SavedState{"
	...
	public CustomFragmentTabHost(Context context) {
		...
		super(context, null);
		initCustomFragmentTabHost(context, null);
	}

	public CustomFragmentTabHost(Context context, AttributeSet attrs) {
		super(context, attrs);
		initCustomFragmentTabHost(context, attrs);
	}

	private void initCustomFragmentTabHost(Context context, AttributeSet attrs) {
